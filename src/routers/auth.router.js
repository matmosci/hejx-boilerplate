...
router.get('/login', (req, res) => res.render("index", { content: "pages/login", user: req.session.user }));
router.get('/login/token', (req, res) => res.render("index", { content: "pages/login-token", email: '', user: req.session.user }));
